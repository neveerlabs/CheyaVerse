...
export default function ViewerClient({
  ...
  return (
    <>
      ...
      >
        {!ready && kind !== "other" && (
          <div className="absolute inset-0 z-[5] pointer-events-none overflow-hidden bg-[#0a0a0a]">
            <div className="absolute inset-0 bg-[linear-gradient(105deg,transparent_38%,rgba(255,255,255,.08)_48%,rgba(255,255,255,.14)_50%,rgba(255,255,255,.08)_52%,transparent_62%)] bg-[length:220%_100%] animate-shimmer" />
          </div>
        )}
      ...
      {(ready || kind === "other") && (
        <div className="flex gap-2.5 mb-3 animate-fade-up">
          <button
            type="button"
            onClick={startDownload}
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-ink hover:bg-accent-hover text-white text-[13.5px] font-semibold transition-all active:scale-[.97]"
          >
          ...
          <button
            ...
            className="w-12 inline-flex items-center justify-center rounded-xl bg-[#fafafa] hover:bg-[#f0f0f0] border border-line text-ink transition-all active:scale-[.97] flex-shrink-0"
          >
